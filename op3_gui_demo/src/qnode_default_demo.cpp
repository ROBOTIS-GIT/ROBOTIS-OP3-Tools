...
{
  std_msgs::msg::String _commnd_msg;
...
void QNodeOP3::applyWalkingParam(const op3_walking_module_msgs::msg::WalkingParam &walking_param)
{
...
{
  robotis_controller_msgs::msg::SyncWriteItem init_gyro_msg;
...
void QNodeOP3::parseMotionMapFromYaml(const std::string &path)
{
  ...
  {
    RCLCPP_ERROR(this->get_logger(), "Fail to load motion yaml.");
    return;
  }
